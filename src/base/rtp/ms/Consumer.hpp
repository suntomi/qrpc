...
namespace ms {
	...
	public:
		...
		public:
			virtual void OnConsumerSendRtpPacket(ms::Consumer* consumer, RTC::RtpPacket* packet) = 0;
			virtual void OnConsumerRetransmitRtpPacket(ms::Consumer* consumer, RTC::RtpPacket* packet) = 0;
			virtual void OnConsumerKeyFrameRequested(ms::Consumer* consumer, uint32_t mappedSsrc) = 0;
			virtual void OnConsumerNeedBitrateChange(ms::Consumer* consumer)                      = 0;
			virtual void OnConsumerNeedZeroBitrate(ms::Consumer* consumer)                        = 0;
			virtual void OnConsumerProducerClosed(ms::Consumer* consumer)                         = 0;
		};
	...
	protected:
		...
		ms::Consumer::Listener* listener{ nullptr };
		RTC::Media::Kind kind;
